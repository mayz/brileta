...
def test_layout_consistency() -> None:
    ...
    _asc_p, desc_p = pillow_backend.get_font_metrics()
...
def test_moderngl_canvas_drawing_operations() -> None:
    ...
    char, _fg_color, bg_color = glyph_buffer.data[0, 0]
