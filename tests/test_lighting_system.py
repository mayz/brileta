...
def test_lighting_cache_hit() -> None:
    ...
    misses_after_first = ls._static_lighting_cache.stats.misses

    result2 = ls.compute_lighting_with_shadows(5, 5, [], viewport_offset=(8, 8))
    assert ls._static_lighting_cache.stats.hits == 1
    assert ls._static_lighting_cache.stats.misses == misses_after_first
