...
class TestTreeFactories:
    ...
    def test_sapling_tree_shadow_height(self) -> None:
        """Saplings should cast shorter shadows than mature trees."""
        sapling = Tree(
            x=2,
            y=3,
            ch="i",
            color=(65, 145, 50),
            tree_type=TreeArchetype.SAPLING,
        )
        assert sapling.shadow_height == 2
