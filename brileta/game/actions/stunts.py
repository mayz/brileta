...
class PushIntent(GameIntent):
    ...
    :class:`~brileta.game.actions.executors.stunts.PushExecutor`.
    """
...
class TripIntent(GameIntent):
    ...
    Execution is performed by
    :class:`~brileta.game.actions.executors.stunts.TripExecutor`.
    """
...
class KickIntent(GameIntent):
    ...
    Execution is performed by
    :class:`~brileta.game.actions.executors.stunts.KickExecutor`.
    """
...
class PunchIntent(GameIntent):
    ...
    Execution is performed by
    :class:`~brileta.game.actions.executors.stunts.PunchExecutor`.
    """
...
class HolsterWeaponIntent(GameIntent):
    ...
    Execution is performed by
    :class:`~brileta.game.actions.executors.stunts.HolsterWeaponExecutor`.
    """
