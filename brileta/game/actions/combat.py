...
class AttackIntent(GameIntent):
    ...
    :class:`~brileta.game.actions.executors.combat.AttackExecutor` through the
    :class:`~brileta.game.turn_manager.TurnManager`.
...
class ReloadIntent(GameIntent):
    ...
    :class:`~brileta.game.actions.executors.combat.ReloadExecutor`.
    """
