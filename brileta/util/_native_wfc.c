/*
 * Native Wave Function Collapse solver for brileta.
 *
...
extern PyObject *brileta_native_wfc_contradiction_error;
...
static void set_wfc_contradiction_error(const char *message) {
    if (brileta_native_wfc_contradiction_error) {
        PyErr_SetString(brileta_native_wfc_contradiction_error, message);
    } else {
