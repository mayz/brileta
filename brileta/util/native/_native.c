...
static PyMethodDef methods[] = {
    ...
    {"sprite_draw_tapered_trunk",
     brileta_native_sprite_draw_tapered_trunk,
     METH_VARARGS,
     "sprite_draw_tapered_trunk(canvas, cx, y_bottom, y_top, w_bottom, w_top, r, g, b, a, "
     "root_flare) -> None\n\n"
     "Draw a trunk as a vertically tapered filled column."},
    {"sprite_stamp_fuzzy_circle",
     brileta_native_sprite_stamp_fuzzy_circle,
     METH_VARARGS,
    ...
    {"sprite_stamp_ellipse",
     brileta_native_sprite_stamp_ellipse,
     METH_VARARGS,
    ...
    {"sprite_batch_stamp_ellipses",
     brileta_native_sprite_batch_stamp_ellipses,
     METH_VARARGS,
    ...
    {"sprite_batch_stamp_circles",
     brileta_native_sprite_batch_stamp_circles,
     METH_VARARGS,
    ...
    {"sprite_generate_deciduous_canopy",
     brileta_native_sprite_generate_deciduous_canopy,
     METH_VARARGS,
     "sprite_generate_deciduous_canopy(canvas, seed, size, canopy_cx, canopy_cy, base_radius, "
     "crown_rx_scale, crown_ry_scale, canopy_center_x_offset, tips, shadow..., mid..., "
     "highlight...) -> list[(x,y)]\n\n"
     "Generate deciduous canopy lobes/shading in C and return lobe centers."},
    {"sprite_fill_triangle",
     brileta_native_sprite_fill_triangle,
     METH_VARARGS,
     "sprite_fill_triangle(canvas, cx, top_y, base_width, height, r, g, b, a) -> None\n\n"
     "Draw a filled isoceles triangle pointing upward."},
    {"sprite_paste_sprite",
     brileta_native_sprite_paste_sprite,
     METH_VARARGS,
     "sprite_paste_sprite(sheet, sprite, x0, y0) -> None\n\n"
     "Alpha-composite sprite onto sheet at pixel offset."},
    {"sprite_darken_rim",
     brileta_native_sprite_darken_rim,
     METH_VARARGS,
    ...
    {"sprite_nibble_canopy",
     brileta_native_sprite_nibble_canopy,
     METH_VARARGS,
     "sprite_nibble_canopy(canvas, seed, center_x, center_y, canopy_radius, nibble_prob, "
     "interior_prob) -> None\n\n"
     "Carve random notches in canopy edge for silhouette variety."},
    {"sprite_nibble_boulder",
     brileta_native_sprite_nibble_boulder,
     METH_VARARGS,
...
static struct PyModuleDef module = {
    PyModuleDef_HEAD_INIT, "_native", "Shared native algorithms for brileta.", -1, methods};
...
PyMODINIT_FUNC PyInit__native(void) {
    ...
    brileta_native_wfc_contradiction_error =
        PyErr_NewException("brileta.util._native.WFCContradictionError", PyExc_Exception, NULL);
    if (!brileta_native_wfc_contradiction_error) {
        Py_DECREF(m);
        return NULL;
    }

    if (PyModule_AddObjectRef(m, "WFCContradictionError", brileta_native_wfc_contradiction_error) <
        0) {
