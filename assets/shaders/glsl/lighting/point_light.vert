...
uniform vec2 u_viewport_offset;  // World coordinate offset (float for sub-pixel camera)
...
void main() {
    ...
    vec2 pixel_in_viewport = v_uv * u_viewport_size;
    v_world_pos = u_viewport_offset + pixel_in_viewport;
}